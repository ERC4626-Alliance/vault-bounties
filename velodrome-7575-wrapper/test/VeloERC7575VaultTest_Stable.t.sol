...
/// @notice Tests for Stable pool 7575Vault wrapper 
contract VeloERC7575VaultStable_ForkTest is Test {
    ...
    function testMint() public {
        ...
        // Assert shares were minted to user
        assertApproxEqRel(
            finalShareBalance, initialShareBalance + sharesToMint, 1e16, "Incorrect final share balance for user"
        );
    ...
    function testRedeem() public {
     ...
     /// The following tests are adobpted from https://github.com/superform-xyz/super-vaults/blob/main/src/uniswap-v2/test/UniswapV2Swap.t.sol
